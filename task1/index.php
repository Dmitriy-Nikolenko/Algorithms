...
if (($stack->count() % 2) == 0) {
    ...
    if ($count1 == 0 && $count2 == 0 && $count3 == 0) {
        echo "Баланс скобок<br> в выражении: {$str}<br> НЕ нарушен";
    } else {
        echo "Баланс скобок<br> в выражении: {$str}<br> НАРУШЕН";
    }

} else {
    echo "Количество скобок<br> в выражении: {$str}<br> НЕ четное";
}
